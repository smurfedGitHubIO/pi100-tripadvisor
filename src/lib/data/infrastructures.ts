    ...
    reviews: [
      {
        ...
        Hindi maikakailang nagbigay ang CCP ng plataporma para sa maraming artistikong produksyon, ngunit hindi nito binubura ang katotohanang ito’y bunga ng maluhong ambisyon at political agenda. Ang gusaling ito ay itinatag sa isang panahong ginamit ang sining upang patahimikin ang masa at pagandahin ang imahe ng isang rehimeng mapaniil. Ngayon, habang patuloy ang operasyon ng CCP bilang institusyong pangkultura, ang anino ng kasaysayan nito ay nananatili. Isa itong paalala na hindi lahat ng magaganda at engrandeng proyekto ay bunga ng malasakit sa bayan. Minsan, ang mga ito ay itinayo hindi upang magsilbi kundi upang maghari.`,
        helpful: 1
      },
    ],
    features: [
